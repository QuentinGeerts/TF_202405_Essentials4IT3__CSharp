...
Compte selected_account = b1["BE02"];
...
Console.WriteLine(" ---- Ajout des comptes épargnes à la banque ---- ");
b1.Ajouter(E1);
b1.Ajouter(E2);
...
Console.WriteLine(" ---- Calculer les intérêts des comptes ---- ");

foreach (var compte in b1.Comptes)
{
    Console.WriteLine("Calcul intérêt pour le compte " + compte.Key);
